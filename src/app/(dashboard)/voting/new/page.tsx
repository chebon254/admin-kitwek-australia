...
export default function NewVotingCampaignPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload campaign thumbnail if provided
      let thumbnailUrl = "";
      if (thumbnail) {
      ...
      const candidateData = await Promise.all(
        candidates.map(async (candidate) => {
          let imageUrl = "";
          if (candidate.image) {
            imageUrl = await uploadFile(candidate.image, "voting-candidates");
          }
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "Failed to create voting campaign");
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Student Body President Election 2025"
                  required
                  disabled={loading}
                />
              </div>
        ...
        {showSuccess && (
          <SuccessNotification
            message="Voting campaign created successfully! Redirecting..."
